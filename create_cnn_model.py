...
def create_alexNet_v1(nb_class, layer_reg):
    """
    ...
    # conv1
    model.add(Convolution2D(48, 3, 11, 11, W_regularizer=l2(layer_reg), init='he_normal', border_mode='valid',subsample=(4,4)))
    # relu1
    model.add(Activation('relu'))
    # pool1
    model.add(MaxPooling2D(poolsize=(2, 2)))
    ...
    # conv2
    # 128個 5x5x48的kernel
    model.add(Convolution2D(128,48, 5, 5, W_regularizer=l2(layer_reg), init='he_normal', border_mode='valid'))
    # relu2
    model.add(Activation('relu'))
    # pool2
    model.add(MaxPooling2D(poolsize=(2, 2)))
    ...
    # conv3
    model.add(Convolution2D(192, 128, 3, 3, W_regularizer=l2(layer_reg), init='he_normal', border_mode='valid'))
    # relu3
    model.add(Activation('relu'))

    # conv4
    model.add(Convolution2D(192, 192, 3, 3, W_regularizer=l2(layer_reg), init='he_normal', border_mode='valid'))
    # relu4
    model.add(Activation('relu'))

    # conv5
    model.add(Convolution2D(128, 192, 3, 3, W_regularizer=l2(layer_reg), init='he_normal', border_mode='valid'))
    # relu5
    model.add(Activation('relu'))
    # pool5
    model.add(MaxPooling2D(poolsize=(2, 2)))
